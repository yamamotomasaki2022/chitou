...
<br>
    ...
    <div class="container">
        <div class="zoomImage" style="background-image:url(images/coco/UserExistError.jpg)">
            <a href="home"><button type="button" class="btn btn-primary" style=" left:290px; top:400px">返回主頁</button></a>
        </div>
        <img src="images/coco/UserExistError.jpg" style="width: 100%">
