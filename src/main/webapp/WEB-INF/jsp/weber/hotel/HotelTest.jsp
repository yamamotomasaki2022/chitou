			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					<li class="nav-item"><a class="nav-link" href="index.html">
							<i class="icon-grid menu-icon"></i> <span class="menu-title">首頁</span>
					</a></li>
					...
					<li class="nav-item"><a class="nav-link"
						...
						aria-controls="form-elements"> <i
							class="icon-columns menu-icon"></i> <span class="menu-title">機票管理</span>
					...
					<li class="nav-item"><a class="nav-link"
						...
						aria-controls="tables"> <i class="icon-grid-2 menu-icon"></i>
							<span class="menu-title">飯店管理</span> <i class="menu-arrow"></i>
					</a>
					...
					<li class="nav-item"><a class="nav-link"
						...
						aria-controls="icons"> <i class="icon-contract menu-icon"></i>
							<span class="menu-title">文章管理</span> <i class="menu-arrow"></i>
					</a>
