...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
	<script>
		...
		$('#fastInput')
				.click(
						function() {
							$('#name').val('煙波大飯店台南館 Lakeshore Hotel Tainan');
							$('#address').val('永福路一段 269 號, 中西區, 台南市, 700');
							$('#type').val('飯店');
							$('#intro').val('煙波大飯店台南館離機場 6.4 公里 (4 英里)，是台南的住宿好選擇。您可以在附設的室外游泳池游上幾圈，活動筋骨的同時也獲得放鬆。想要用餐時，這裡的隱糧餐酒館 Secret and Senses可以推薦給您，他們供應美味的義大利料理，在 早餐、午餐和晚餐時間均有開放。此頂級飯店還有健身中心、三溫暖和蒸氣室。住過的人都對住宿的整體性價比和位置鄰近購物區讚不絕口。');
							$('#country').val('台灣');
							$('#phone').val('02-2523-1111');
							$('#status').val('營業中');
							$('#capacity').val('2000');
							$('#owner').val('煙波國際觀光集團');
							$('#averagePrice').val('3165');
						});
