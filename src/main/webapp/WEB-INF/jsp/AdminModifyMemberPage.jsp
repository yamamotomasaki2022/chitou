		...
		<div class="card">
			<div class="card-body">
				...
				<form class="forms-sample" action="AdminModifyMember" method="post"
					...
					<div class="form-group">
						<input type="hidden" name="statusid" value="<%=bean.getStatusid()%>" class="form-control">
					</div>
					...
					<div class="form-group">
						<label>密碼</label> <input class="form-control" type="text"
							name="password" value="<%=bean.getPassword()%>" placeholder="password">
					</div>
