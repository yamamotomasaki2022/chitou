...
<body>
		<%@ include file="/WEB-INF/includes/SuperTop.jsp"%>
									...
									<!--form開始-->
									<form:form class="forms-sample" action="updateFlightTicketAction" method="post" modelAttribute="flightticket1" enctype="multipart/form-data">
									<form:input type="hidden" path="flightid" value="${flightticket1.flightid}" class="form-control" />
									<form:input type="hidden" path="airline" value="${flightticket1.airline}" class="form-control" />
									<form:input type="hidden" path="classid" value="${flightticket1.classid}" class="form-control" />	

										<div class="form-group">
											<form:label  path="originid">出發機場:</form:label>
											 <form:input type="text" path="originid" class="form-control"
										...
										<div class="form-group">
											<form:label  path="destinationid">降落機場:</form:label>
											 <form:input type="text" path="destinationid" class="form-control"
										...
										<div class="form-group">
											...
											<form:input type="number" path="fare" class="form-control"
